...
""",
    urls = ['https://github.com/nunit/nunitv2/releases/download/2.6.4/NUnit-2.6.4.zip'],
...
http_archive(
    ...
    urls = ['http://www.nuget.org/api/v2/package/Moq/4.2.1510.2205'],
    type = 'zip'
)
...
http_archive(
    ...
    urls = ['https://www.nuget.org/api/v2/package/Newtonsoft.Json/9.0.1'],
    type = 'zip'
)
...
http_archive(
    ...
    urls = ['https://www.nuget.org/api/v2/package/NDesk.Options/0.2.1'],
    type = 'zip'
)
...
""",
    urls = ['https://s3.amazonaws.com/krpc/lib/asio/asio-1.12.1.tar.gz'],
...
filegroup(
    ...
    urls = ['https://github.com/djungelorm/protobuf-lua/archive/v1.1.1.tar.gz'],
...
http_file(
    name = 'module_manager',
    urls = ['https://ksp.sarbian.com/jenkins/job/ModuleManager/149/artifact/ModuleManager.4.0.2.dll'],
    sha256 = '7bf4a89b3f37a186b166b2e941333c25ff68ae1bc9a40c7e137a3594b9e55a78'
)
